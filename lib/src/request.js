...
exports.makeRequest = function postRequest({ self, endpoint, methodName, token }) {
    let dataString = '';
    if (self.data) {
...
module.exports = { getRequest: exports.getRequest, makeRequest: exports.makeRequest, base64Encode };
